...
Zaladuj3DTexty()
{
	...
	CreateDynamic3DTextLabel("Aby kupiæ jedzenie wpisz /kupjedzenie", COLOR_WHITE, 369.67, -6.65, 1001.85, 20.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0, 1, 9, -1); // cluckin bell idlewood
	...
	RybyTop = CreateDynamic3DTextLabel("Najwiêksze ryby:", COLOR_WHITE, 837.64, -2065.83, 14.31, 15);
	...
	CreateDynamic3DTextLabel("Urz¹d Miasta", 0x9ACD32AA, 1310.0885, -1367.6865, 13.8504, 50.0); //City Hall
	CreateDynamic3DTextLabel("Urz¹d Miasta - zaplecze", 0x9ACD32AA, 1285.5134, -1329.1538, 13.5492, 10.0); //City Hall
	...
	new str2[512];
    str2 = "{FFA500}Dowód osobisty - {9ACD32}20$ + akt urodz.\n{FFA500}Wydanie Prawa Jazdy - {9ACD32}20$ + zal. egz.\n {FFA500}Patent ¯eglarski - {9ACD32}120$\n {FFA500}Pozwolenie na bron - {9ACD32}250$\n {FFA500}Licencja Pilota - {9ACD32}700$\n {FFA500}Karta wêdkarska - {9ACD32}30$\n{9ACD32}Egzamin teoretyczny - 30${FFA500}\n{9ACD32}Egzamin praktyczny- {9ACD32} 40$";
...
//-------------------------------[Przystanki autobusowe]----------------------------------------
	...
	CreateDynamic3DTextLabel("Biurowiec\n'Kotnik'", COLOR_BROWN, 330.6893,-1513.0613,35.8672, 100.0);
